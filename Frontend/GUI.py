...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        self.gif_label = QLabel()
        movie = QMovie(GraphicsDirectoryPath('Bankai.gif'))

        movie.jumpToFrame(0)  
        original_size = movie.currentImage().size()
        movie.setScaledSize(original_size)
        ...
        self.icon_label.setFixedSize(500, 150)
        pixmap = QPixmap(GraphicsDirectoryPath("Mic_on.png")).scaled(60, 60, Qt.KeepAspectRatio, Qt.SmoothTransformation)
